...
<!-- 表单校验插件 -->		
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/assets/validate/jquery.validate.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/assets/validate/additional-methods.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/js/messages_zh.js"></script>
	<!-- 表单校验插件 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/js/jquery.form.js"></script>
<script>

...
! function(a, b) {
	...
	h.anim = ["layui-anim", "layui-anim-01", "layui-anim-02", "layui-anim-03", "layui-anim-04", "layui-anim-05", "layui-anim-06"], g.pt.config = {
		...
		a.vessel(j, function(d, e,f) {
			...
			// ----------------------   获取loading 加载是第几个 图片改变样式
			var domSize = (3 == f.type ? f.icon : "");
			$(".layui-layer-loading"+domSize).css({
				"width":f.width || "auto",
				"height":f.height || "auto",
				"background-image":"url(.."+$$("static/common/assets/layer/skin/default/loading-"+domSize+".gif")
			});
